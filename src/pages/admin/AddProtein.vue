<template>
    <dashboard-layout>
        <div slot="main-content">
            <h2 class="dash-title">Add Protein</h2>
            
            <section class="recent">
                <div class="">
                    <div class="activity-card pad-1">
                        <div class="form-group">
                            <label for="">Protein name</label>
                            <input type="text" v-model="name" class="form-control" placeholder="Protein name">
                        </div>
                        <div class="form-group">
...
export default {
    ...
    methods: {
        addProtein() {
            ...
            this.$axios.post(`${this.$apiUrl}/protein/add`, {name: this.name, price: this.price}, {
                headers: {
                    Authorization: `Bearer ${localStorage.authtoken}`
                }
            })
            .then(() => {
                this.$router.push('/admin/Protein')
            })
            .catch(error => {
